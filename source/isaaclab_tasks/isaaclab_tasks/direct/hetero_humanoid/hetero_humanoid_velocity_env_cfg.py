...
class RewardsCfg:
    ...
    lin_vel_z_l2_cassie = RewTerm(
        func=custom_mdp.lin_vel_z_l2, weight=-2.0, params={"asset_cfg": SceneEntityCfg("cassie")}
    )
    ang_vel_xy_l2_cassie = RewTerm(
        func=custom_mdp.ang_vel_xy_l2, weight=-0.05, params={"asset_cfg": SceneEntityCfg("cassie")}
    )
    dof_torques_l2_cassie = RewTerm(
        func=custom_mdp.joint_torques_l2, weight=-5.0e-6, params={"asset_cfg": SceneEntityCfg("cassie")}
    )
    dof_acc_l2_cassie = RewTerm(
        func=custom_mdp.joint_acc_l2, weight=-3.75e-7, params={"asset_cfg": SceneEntityCfg("cassie")}
    )
    action_rate_l2_cassie = RewTerm(
        func=custom_mdp.action_rate_l2, weight=-0.015, params={"asset_cfg": SceneEntityCfg("cassie")}
    )
    ...
    termination_penalty_cassie = RewTerm(
        func=custom_mdp.is_terminated, weight=-200.0, params={"asset_cfg": SceneEntityCfg("cassie")}
    )
    ...
    lin_vel_z_l2_digit = RewTerm(
        func=custom_mdp.lin_vel_z_l2, weight=-2.0, params={"asset_cfg": SceneEntityCfg("digit")}
    )
    ang_vel_xy_l2_digit = RewTerm(
        func=custom_mdp.ang_vel_xy_l2, weight=-0.1, params={"asset_cfg": SceneEntityCfg("digit")}
    )
    dof_torques_l2_digit = RewTerm(
        func=custom_mdp.joint_torques_l2, weight=-1.0e-6, params={"asset_cfg": SceneEntityCfg("digit")}
    )
    dof_acc_l2_digit = RewTerm(
    ...
    action_rate_l2_digit = RewTerm(
        func=custom_mdp.action_rate_l2, weight=-0.008, params={"asset_cfg": SceneEntityCfg("digit")}
    )
    ...
    flat_orientation_l2_digit = RewTerm(
        func=custom_mdp.flat_orientation_l2, weight=-2.5, params={"asset_cfg": SceneEntityCfg("digit")}
    )
    feet_slide_digit = RewTerm(
        func=custom_mdp.feet_slide,
        weight=-0.25,
        params={
            "sensor_cfg": SceneEntityCfg("digit_contacts", body_names=".*_leg_toe_roll"),
            "asset_cfg": SceneEntityCfg("digit", body_names=".*_leg_toe_roll"),
        },
    )
    dof_pos_limits_digit = RewTerm(
        func=custom_mdp.joint_pos_limits,
        weight=-1.0,
        params={"asset_cfg": SceneEntityCfg("digit", joint_names=[".*_leg_toe_roll", ".*_leg_toe_pitch", ".*_tarsus"])},
    )
    stand_still_digit = RewTerm(
        func=custom_mdp.stand_still_joint_deviation,
        weight=-0.4,
        params={
            "command_name": "base_velocity",
            "command_threshold": 0.06,
            "asset_cfg": SceneEntityCfg("digit", joint_names=LEG_JOINT_NAMES),
        },
    )
    no_jumps_digit = RewTerm(
        func=custom_mdp.desired_contacts,
        weight=-0.5,
    ...
    termination_penalty_digit = RewTerm(
        func=custom_mdp.is_terminated, weight=-100.0, params={"asset_cfg": SceneEntityCfg("digit")}
    )
    joint_deviation_hip_roll_digit = RewTerm(
        func=custom_mdp.joint_deviation_l1,
        weight=-0.1,
        params={"asset_cfg": SceneEntityCfg("digit", joint_names=".*_leg_hip_roll")},
    )
    joint_deviation_hip_yaw_digit = RewTerm(
        func=custom_mdp.joint_deviation_l1,
        weight=-0.2,
        params={"asset_cfg": SceneEntityCfg("digit", joint_names=".*_leg_hip_yaw")},
    )
    joint_deviation_knee_digit = RewTerm(
        func=custom_mdp.joint_deviation_l1,
        weight=-0.2,
        params={"asset_cfg": SceneEntityCfg("digit", joint_names=".*_tarsus")},
    )
    joint_deviation_feet_digit = RewTerm(
        func=custom_mdp.joint_deviation_l1,
        weight=-0.1,
        params={"asset_cfg": SceneEntityCfg("digit", joint_names=[".*_toe_a", ".*_toe_b"])},
    )
    joint_deviation_arms_digit = RewTerm(
        func=custom_mdp.joint_deviation_l1,
        weight=-0.2,
        params={"asset_cfg": SceneEntityCfg("digit", joint_names=".*_arm_.*")},
    )
    ...
    dof_torques_l2_g1 = RewTerm(
        func=custom_mdp.joint_torques_l2,
        weight=-2.0e-6,
        params={"asset_cfg": SceneEntityCfg("g1", joint_names=[".*_hip_.*", ".*_knee_joint"])},
    )
    dof_acc_l2_g1 = RewTerm(
        func=custom_mdp.joint_acc_l2,
        weight=-1.0e-7,
        params={"asset_cfg": SceneEntityCfg("g1", joint_names=[".*_hip_.*", ".*_knee_joint"])},
    )
    action_rate_l2_g1 = RewTerm(
        func=custom_mdp.action_rate_l2, weight=-0.005, params={"asset_cfg": SceneEntityCfg("g1")}
    )
    ...
    flat_orientation_l2_g1 = RewTerm(
        func=custom_mdp.flat_orientation_l2, weight=-1.0, params={"asset_cfg": SceneEntityCfg("g1")}
    )
    feet_slide_g1 = RewTerm(
        ...
        params={
            "sensor_cfg": SceneEntityCfg("g1_contacts", body_names=".*_ankle_roll_link"),
            "asset_cfg": SceneEntityCfg("g1", body_names=".*_ankle_roll_link"),
        },
    )
    dof_pos_limits_g1 = RewTerm(
        func=custom_mdp.joint_pos_limits,
        weight=-1.0,
        params={"asset_cfg": SceneEntityCfg("g1", joint_names=[".*_ankle_pitch_joint", ".*_ankle_roll_joint"])},
    )
    termination_penalty_g1 = RewTerm(
        func=custom_mdp.is_terminated, weight=-200.0, params={"asset_cfg": SceneEntityCfg("g1")}
    )
    joint_deviation_hip_g1 = RewTerm(
        func=custom_mdp.joint_deviation_l1,
        weight=-0.1,
        params={"asset_cfg": SceneEntityCfg("g1", joint_names=[".*_hip_yaw_joint", ".*_hip_roll_joint"])},
    )
    ...
    joint_deviation_fingers_g1 = RewTerm(
        func=custom_mdp.joint_deviation_l1,
        weight=-0.05,
        params={
            "asset_cfg": SceneEntityCfg(
    ...
    joint_deviation_torso_g1 = RewTerm(
        func=custom_mdp.joint_deviation_l1,
        weight=-0.1,
        params={"asset_cfg": SceneEntityCfg("g1", joint_names="torso_joint")},
    )
    ...
    dof_torques_l2_h1 = RewTerm(
        func=custom_mdp.joint_torques_l2, weight=0.0, params={"asset_cfg": SceneEntityCfg("h1")}
    )
    dof_acc_l2_h1 = RewTerm(func=custom_mdp.joint_acc_l2, weight=-1.25e-7, params={"asset_cfg": SceneEntityCfg("h1")})
    action_rate_l2_h1 = RewTerm(
        func=custom_mdp.action_rate_l2, weight=-0.005, params={"asset_cfg": SceneEntityCfg("h1")}
    )
    ...
    feet_slide_h1 = RewTerm(
        func=custom_mdp.feet_slide,
        weight=-0.25,
        params={
            "sensor_cfg": SceneEntityCfg("h1_contacts", body_names=".*ankle_link"),
            "asset_cfg": SceneEntityCfg("h1", body_names=".*ankle_link"),
        },
    )
    dof_pos_limits_h1 = RewTerm(
        func=custom_mdp.joint_pos_limits,
        weight=-1.0,
        params={"asset_cfg": SceneEntityCfg("h1", joint_names=".*_ankle")},
    )
    termination_penalty_h1 = RewTerm(
        func=custom_mdp.is_terminated, weight=-200.0, params={"asset_cfg": SceneEntityCfg("h1")}
    )
    joint_deviation_hip_h1 = RewTerm(
        func=custom_mdp.joint_deviation_l1,
        weight=-0.2,
        params={"asset_cfg": SceneEntityCfg("h1", joint_names=[".*_hip_yaw", ".*_hip_roll"])},
    )
    joint_deviation_arms_h1 = RewTerm(
        func=custom_mdp.joint_deviation_l1,
        weight=-0.2,
        params={"asset_cfg": SceneEntityCfg("h1", joint_names=[".*_shoulder_.*", ".*_elbow"])},
    )
    joint_deviation_torso_h1 = RewTerm(
