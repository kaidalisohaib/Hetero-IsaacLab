...
class UniversalSceneCfg(InteractiveSceneCfg):
    ...
    # 13 Robots (8 Quadrupeds + 5 Humanoids)
    ...
    h2 = H2_MINIMAL_CFG.replace(prim_path="/World/envs/env_.*/h2")
...
def main():
    ...
    configs = [
        ...
        scene_cfg.anymal_c,
        scene_cfg.anymal_b,
        scene_cfg.unitree_a1,
        scene_cfg.unitree_go1,
        scene_cfg.unitree_go2,
        scene_cfg.unitree_b2,
        scene_cfg.spot,
        scene_cfg.cassie,
        scene_cfg.digit,
        scene_cfg.g1,
